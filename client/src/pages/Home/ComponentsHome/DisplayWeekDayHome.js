...
import "../css/DisplayWeekDayHome.css"
let objStops = 0
let direction = false
const DisplayWeekDayHome = ({ selectLine2 }) => {
	...
	return (
		<section className="sectionLinesDisplayStreetsT">
			<div className="headerSectionDisplayStreets">
				<span className="switchClass">Robocze</span>
			</div>
			<section className="contentDisplayStreets">
				<div className="tbl-header posr">
				<i onClick={() => switchDirection()} className="ti ti-refresh iconRefreshh2"></i>
...
export default DisplayWeekDayHome
