...
const News = () => {
	...
	const validationSchema = Yup.object().shape({
		nameNews: Yup.string().required('Pole wymagane'),
	...
	return (
		<section className="sectionLinesDisplayStreetsT">
			...
			<div>
				<Modal isOpen={isOpen} className="custom-modal modalnews" overlayClassName="custom-overlay" onRequestClose={closeModal}>
						...
						<Form>
							<section className="">
								...
								<span className="closeMod " onClick={closeModal}>
									...
									<ErrorMessage className="errorMessage" component="span" name="nameNews" />
								
                                <br />
								<Field type="text" name="nameNews" placeholder="Nazwa" />
                                <br/>
